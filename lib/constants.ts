...
export const THREE_PARTY = {
  ...
  quote:
    '"The most powerful interventions in education have always been partnerships — technology alone changes nothing without the institutions that give it meaning."',
  parties: [
    {
      iconName: 'Cpu',
      name: 'UMOJA-ai',
