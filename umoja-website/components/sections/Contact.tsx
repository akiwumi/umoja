...
const fieldBase =
  'w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-sm text-white placeholder-white/30 outline-none transition-all duration-200 focus:border-[#6A9556] focus:bg-white/10 focus:ring-1 focus:ring-[#6A9556] min-h-[44px]';
...
function SuccessCheckmark() {
  return (
    ...
    >
      <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-[#1E3318]/60 border-2 border-[#6A9556]">
        <svg
          viewBox="0 0 48 48"
          fill="none"
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2 md:gap-12 md:items-start">
          ...
          <RevealOnScroll direction="right">
            <div className="flex flex-col gap-8">
              {/* Badge */}
              <span className="inline-block w-fit rounded-full border border-[#6A9556]/40 bg-[#6A9556]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#8AAF78]">
                Get Involved
              </span>
              ...
              <div>
                ...
                <div className="h-px w-20 bg-gradient-to-r from-[#E8BC20] to-transparent mb-6" />
              ...
              <ul className="flex flex-col gap-4">
                {CONTACT.trustItems.map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <CheckCircle
                      size={18}
                      className="text-[#8AAF78] flex-shrink-0"
                      strokeWidth={2}
                    />
              ...
              {/* Decorative element */}
              <div className="hidden md:block mt-4 rounded-xl border border-[#E8BC20]/20 bg-[#E8BC20]/5 p-5">
                <p className="text-xs text-[#E8BC20]/70 leading-relaxed italic">
                  &ldquo;Education is the most powerful weapon which you can use to change the world.&rdquo;
                  <span className="block mt-2 not-italic font-semibold text-[#E8BC20]/50">— Nelson Mandela</span>
                </p>
              </div>
            </div>
          </RevealOnScroll>
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          defaultValue=""
                        >
                          <option value="" disabled className="bg-[#22261C] text-white/40">
                            Select role
                          </option>
                          {ROLE_OPTIONS.map((opt) => (
                            <option
                              key={opt.value}
                              value={opt.value}
                              className="bg-[#22261C] text-white"
                            >
                              {opt.label}
                            </option>
                          ))}
                      ...
                      {submitting ? (
                        <span className="flex items-center gap-2">
                          <motion.span
                            ...
                            className="inline-block h-4 w-4 rounded-full border-2 border-[#1A1D16]/30 border-t-[#1A1D16]"
                          />
                          Sending…
                        </span>
                      ) : (
