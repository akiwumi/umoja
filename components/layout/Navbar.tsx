    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-8">
        ...
        <a
          ...
          className="font-display text-xl font-bold tracking-tight text-[#66BB6A] hover:text-[#81C784] transition-colors"
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="overflow-hidden bg-[#1A1A2E]/98 backdrop-blur-md border-t border-white/10 md:hidden"
          >
