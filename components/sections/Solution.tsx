    ...
    <section className="bg-[#1A1A2E] section-padding">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <RevealOnScroll direction="up" delay={0.1}>
          <p className="text-center text-xl font-medium text-[#FFCA28] mb-16 italic">
            ...
            return (
              ...
              >
                <GlowCard className="h-full flex flex-col">
                  {/* Icon */}
                  <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-[#1B5E20]/60 text-[#66BB6A]">
