  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, rgba(5,31,5,0.82) 0%, rgba(10,61,10,0.75) 40%, rgba(26,26,46,0.92) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% 40%, rgba(76,175,80,0.07) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-24 text-center md:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-6">
            <span className="inline-block rounded-full border border-[#4CAF50]/40 bg-[#4CAF50]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#66BB6A]">
          ...
          <motion.div
            variants={itemVariants}
            className="mx-auto mt-6 mb-8 h-px w-24 bg-gradient-to-r from-transparent via-[#F9A825] to-transparent"
          />
